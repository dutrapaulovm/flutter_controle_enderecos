...
import 'package:flutter_controle_enderecos/presentation/app/list_model.dart';
...
import 'package:flutter_controle_enderecos/presentation/widgets/search_field.dart';

typedef FilterFunction<E> = bool Function(E item);
typedef EntityTapCallback<E> = Future<void> Function(E entity);
typedef DeleteEntityCallback<E> = Future<ResultData> Function(E entity);
...
class GenericSearchScreenState<E extends Entity<E>>
  ...
  void _onSearchChanged(String value) async {
    if (value.isEmpty) {
      ...
      if (fieldGetter != null) {
        await itemProvider.filterBy((item) => fieldGetter(item)
            .toString()
            .toLowerCase()
