...
class SearchEstadoScreenOld extends StatefulWidget {
  static const String routeName = "/search_estado_screen";

  const SearchEstadoScreenOld({super.key});

  @override
  State<SearchEstadoScreenOld> createState() => SearchEstadoScreenStateOld();
}

class SearchEstadoScreenStateOld
