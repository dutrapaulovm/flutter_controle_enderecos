...
class _RegisterUserFormWidgetState extends State<RegisterUserFormWidget> {
  ...
  void initState() {
    ...
    widget.userController.usuarioViewModel.dataNotifier.addListener(() {
      ...
      widget.userController.usuarioViewModel.dataNascimentoController
          .text = date !=
              null
  ...
  void preencherControllersComDadosFicticios() {
    ...
    viewModel.dataNotifier.value =
        DateTime.tryParse('1990-05-15'); // formato ISO para DateTime
    ...
    return AppForm(
        ...
        child: Column(
          ...
          children: [
            ...
            InputFormField(
              controller:
                  widget.userController.usuarioViewModel.loginController,
              labelText: 'Login',
            ...
            InputFormField(
              controller:
                  widget.userController.usuarioViewModel.emailController,
              labelText: 'Email',
            ...
            InkWell(
                child: GestureDetector(
                    ...
                    child: AbsorbPointer(
                      ...
                      controller: widget.userController.usuarioViewModel
            ...
            InputFormField(
              controller: widget
                  .userController.usuarioViewModel.confirmPasswordController,
  ...
  Future<void> _selectDate() async {
    final picked = await showDatePicker(
      context: context,
      initialDate: widget.userController.usuarioViewModel.dataNotifier.value ??
          DateTime.now(),
